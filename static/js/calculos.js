...
function CalculoHorometroTotal(){
    ...
    document.getElementById('horometroTotal').innerHTML = '<input value="'+strMsg+'" type="number" name="horometro_total" class="form-reporte" placeholder="Horómetro Total" id="id_horometro_total" required="" step="0.01">';
}